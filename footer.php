			...
			<div class="col-lg-4 col-sm-6 footer-grid-wthree mt-lg-0 mt-sm-5 mt-4">
				...
				<div class="contact-info">
					<div class="footer-style-w3ls">
						...
						<p>5 Akinmade Street Anthony Village Ikeja, Lagos State</p>
					</div>
					<div class="footer-style-w3ls my-3">
						<h4 class="mb-2"><span class="fa mr-1 fa-phone"></span> Phone</h4>
						<p><a href="tel:+2347061547520">+234 706 154 7520</a></p>
					</div>
					<div class="footer-style-w3ls">
						<h4 class="mb-2"><span class="fa mr-1 fa-envelope-open"></span> Email</h4>
						<p><a href="mailto:info@uniqueoceans.com">info@uniqueoceans.com</a></p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-sm-6 footer-grid-wthree mt-lg-0 mt-sm-5 mt-4">
				...
				<ul class="links list-unstyled">
					...
					<li class=""><a href="index.php#our-services">Our Services</a></li>
					<li class=""><a href="index.php#partners">Partners</a></li> 
